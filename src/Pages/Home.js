...
import bg from "../img/exp2.svg";
const Home = () => {
  return (
    <>
      <section className="position-relative pb-6">
        <img
          ...
          <div className="container">
            <div className="row pt-5">
              <div className="col-12 col-lg-5 ms-auto">
                <div className="mb-5">
                  <h2 className="display-4 fw-bold mb-5">Money Manager</h2>
                ...
                <h1 className="text-danger">Login Info </h1>
                <p>User name: hiteshvishal@gmail.com</p>
                <p>password: 12345</p>
